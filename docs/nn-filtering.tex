...
\begin{align}
  ...
  + \left\|C\right\|
\end{align}
% For less conservatism, it would 
% Suppose that \(A\) has \(m\) rows and \(n\) columns.
% \begin{align}
%   \begin{split}
%     % \MoveEqLeft
%   \sup_{x} \left\|2 A^\intercal \operatorname{diag} \cbr{\phi(Ax + b)} + C^\intercal\right\|^2
%   \\
%   &\leq
%   \sup_{\xi \in [0, \sqrt{2/\pi}]^m} 
%   \left\|
%     2 A^\intercal \operatorname{diag}(\xi) + C^\intercal
%   \right\|^2
%   \end{split}
%   \\
%   &\leq
%   \sup_{\omega \in \mathbb R^n, \|\omega\| = 1} \sup_{\xi \in [0, \sqrt{2/\pi}]^m} 
%   \left\|
%     2 \omega^\intercal A^\intercal \operatorname{diag}(\xi) + \omega^\intercal C^\intercal
%   \right\|^2
%   \\
%   &\leq
%   \sup_{\omega \in \mathbb R^n, \|\omega\| = 1} \sup_{\xi \in [0, \sqrt{2/\pi}]^m} 
