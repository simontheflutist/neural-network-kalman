...
% , yet as the examples show, we are optimistic that realistic neural networks are readily amenable to analytic uncertainty propagation.
...
% \begin{proof}
%   Suppose that \(\psi: \{0, 1\}^n \to \{0, 1\}\) is given by a 
% \end{proof}
